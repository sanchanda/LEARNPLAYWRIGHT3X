...
var This_is_a_very_long_name_variable = "Santosh";
...
let strLastName = "string prefix";
let bActiveMember = true;       // boolean
let nCounter = 5;           // number
let arrOfItems = [];        // array


let strGivenName = "Santosh";